...
<body>
	...
	<%
		...
		String query1="SELECT uid from customers WHERE uid=?";
		String query2="INSERT INTO customers(uid,pass1,fname,lname,email,address,phno,pass2) VALUES(?,?,?,?,?,?,?,?)";


		try{		
			Class.forName("com.mysql.cj.jdbc.Driver");
			conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/mysql","root","Rocky@244");
